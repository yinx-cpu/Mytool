                ...
                if home == "1":
                    ...
                    while True:
                        ...
                        if third == "1":
                            ...
                            if sec == "1":
                                ...
                                ourl("https://1pvfnn.0450.me/")
                            elif sec == "3":
                                ourl("https://18comic.vip")
                            else:
                                break
                        elif third == "2":
                            while True:
                    ...
                    while True:
                        ...
                        if sevenird == "1":
                            ...
                            zpath = input("请输入zip文件路径：")
                            topath = input("解压到(默认Mytool)：") or "/sdcard/Mytool/Unzip/"
                            if os.path.exists(zpath):
                                os.system(f"unzip -o '{zpath}' -d '{topath}'")
                                print("解压完成")
                                print("正在删除文件......")
                ...
                while True:
                    if jianji == "1":
                        ...
                        while True:
                                ...
                                Ch = input()
                                if Ch == "1":
                                    urllib.request.urlretrieve("https://js.a.kspkg.com/kos/nlav10814/kuaiying-generic--7.44.0.744005_x64_84ad90.apk",savea)
                                elif Ch == "2":
                                    urllib.request.urlretrieve("https://lf9-apk.ugapk.cn/package/apk/videocut/18076_199001600/videocut_pc_jianying_android_v18076_199001600_c6cd_1779881403.apk",savea)
                                else:
                                    exit()
                    elif jianji == "2":
                        print("暂时不知如何做....")
